...
class word-pdf:
	...
	def pdf-maker(num,*word):
		wordlist[]={"","",}
		for w in word: wordlist[2*w]=word
		...
		for t in range(1,3):
			...
			for i in range(1,11):
				page.drawString(20*mm, (260-(i-1)*25)*mm, "("+str(i)+")"+wordlist[2*i-2])
				if t==2: page.drawRightString(190*mm, (252-(i-1)*25)*mm ,wordlist[2*i-1])
